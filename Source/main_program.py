...
def workflow(input_name, input_type='video', roi=None, convert_to_grayscale=False,
    ...
    """
    Execute the whole stacking workflow for a test case. This can either use a video file (.avi .mov .ser)
    or still images stored in a single directory.

    :param input_name: Video file (.avi .mov .ser) or name of a directory containing still images
