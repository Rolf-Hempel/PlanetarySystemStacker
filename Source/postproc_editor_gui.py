...
class Ui_postproc_editor(object):
    ...
    def retranslateUi(self, postproc_editor):
        ...
        self.SharpeningLayerWidget_1.setText(_translate("postproc_editor", "Placeholder: SharpeningLayer_Widget 1"))
        self.SharpeningLayerWidget_2.setText(_translate("postproc_editor", "Placeholder: SharpeningLayer_Widget 2"))
        self.label_message.setText(_translate("postproc_editor", "Message with user instructions"))
        ...
        self.VersionManagerWidget.setText(_translate("postproc_editor", "Placeholder: VersionManagerWidget"))
        self.SharpeningLayerWidget_3.setText(_translate("postproc_editor", "Placeholder: SharpeningLayer_Widget 3"))
        self.SharpeningLayerWidget_4.setText(_translate("postproc_editor", "Placeholder: SharpeningLayer_Widget 4"))
        self.FrameViewer.setText(_translate("postproc_editor", "Placeholder: FrameViewer"))
